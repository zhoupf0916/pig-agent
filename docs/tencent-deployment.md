...
## 2026-09-26 上下文、恢复与观测发布

当前 release：`20260926-runtime-b1d7a71`，控制面、网关和四个 Runner 已更新。上线前备份：`backups/daily/20260926T101656Z.dump` 与配套配置归档；回滚镜像标签 `before-runtime-b1d7a71`。
