...
export function resolveCloudMode(
  env: NodeJS.ProcessEnv = process.env,
): CloudMode {
...
export function resolveCloudToken(
  env: NodeJS.ProcessEnv = process.env,
): string {
...
export function resolveCloudRepoUrl(
  env: NodeJS.ProcessEnv = process.env,
): string {
  return env.PIG_CLOUD_REPO_URL?.trim() || "";
}

export function resolveCloudRepoRef(
  env: NodeJS.ProcessEnv = process.env,
): string {
...
export function resolveCloudRunsDir(
  env: NodeJS.ProcessEnv = process.env,
): string {
